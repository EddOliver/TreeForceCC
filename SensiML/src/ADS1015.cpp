/*
  ...
  Edited by Victor Altamirano @ Quick Feather, Hackster Contest, April 12th, 2021
...
//Quick Feather Delay and Millis Implementation

extern "C" void HAL_DelayUSec(uint32_t usecs); //Quick Feather Delay Implementation
...
// Original Library with corrections
...
uint16_t ADS1015::getSingleEnded(uint8_t channel)
{
  ...
  HAL_DelayUSec(1000 * 1); // Delay Implementation Quick Feather
